...
/* harmony import */ var _services_apuntes_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/apuntes.service */ "./src/app/services/apuntes.service.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(apuntesService, searchService) {
        var _this = this;
        ...
        this.searchTerm$.subscribe(function (input) {
            _this.visible = true;
            if (input === '') {
                _this.visible = false;
                _this.cleanSearch();
    ...
    DashboardComponent.prototype.cleanSearch = function () {
        //this.busqueda = '';
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_1__('#buscador').val('');
        this.visible = false;
        this.apuntesService.getApuntes()
            .subscribe(function (data) {
            _this.apuntes = data;
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_apuntes_service__WEBPACK_IMPORTED_MODULE_2__["ApuntesService"],
...
var SearchService = /** @class */ (function () {
    ...
    SearchService.prototype.search = function (terms) {
        var _this = this;
        return terms.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(400), // Espera a que no haya datos nuevos el tiempo indicado
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])(), // Envía los datos una sola vez
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (term) { return _this.searchEntries(term); }));
    };
